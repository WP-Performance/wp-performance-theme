...
/**
 * Title: List Posts Category
 * Slug: press-wind/list-posts-category
...
<div class="wp-block-group alignfull" style="padding-right:0;padding-left:0">
    <!-- wp:query {"queryId":0,"query":{"perPage":"5","pages":0,"offset":0,"postType":"post","order":"desc","orderBy":"date","author":"","search":"","exclude":[],"sticky":"","inherit":true},"align":"full","layout":{"type":"default"}} -->
